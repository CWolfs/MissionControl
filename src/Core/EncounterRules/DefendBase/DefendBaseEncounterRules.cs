...
namespace MissionControl.Rules {
  public class DefendBaseEncounterRules : EncounterRules {
    ...
    public void BuildSpawns() {
      ...
      EncounterLogic.Add(new SpawnLanceAroundTarget(this, "SpawnerLanceEnemyWave1", "PlotBase", SpawnLogic.LookDirection.TOWARDS_TARGET, 400f, 500f));
      ...
      EncounterLogic.Add(new SpawnLanceMembersAroundTarget(this, "SpawnerLanceEnemyWave1", "SpawnerLanceEnemyWave1", "PlotBase", SpawnLogic.LookDirection.TOWARDS_TARGET, 0f, 100f));
      EncounterLogic.Add(new SpawnLanceMembersAroundTarget(this, "SpawnerLanceEnemyWave2", "SpawnerLanceEnemyWave2", "PlotBase", SpawnLogic.LookDirection.TOWARDS_TARGET, 0f, 100f));
      EncounterLogic.Add(new SpawnLanceMembersAroundTarget(this, "SpawnerLanceEnemyWave3", "SpawnerLanceEnemyWave3", "PlotBase", SpawnLogic.LookDirection.TOWARDS_TARGET, 0f, 100f));
    }
