...
namespace MissionControl.Result {
  public class SetUnitEvasionTicksByTagResult : EncounterResult {
    public string[] Tags { get; set; }
    public int Amount { get; set; }

    public override void Trigger(MessageCenterMessage inMessage, string triggeringName) {
      Main.LogDebug($"[SetUnitEvasionTicksByTagResult] Setting evasion '{Amount}' on combatants with tags '{String.Concat(Tags)}'");
      ...
      Main.LogDebug($"[SetUnitEvasionTicksByTagResult] Found'{combatants.Count}' combatants");
